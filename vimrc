...
func SetTitle() 
    ...
    elseif &filetype == 'python'
	    ...
	    call append(line(".")+1, "") 
		call append(line(".")+2, "#########################################################################") 
		call append(line(".")+3, "#Author:libanghuai") 
		call append(line(".")+4, "#Email:libanghuai@pku.edu.cn") 
...
"        call setline(1,"<head><meta charset=\"UTF-8\"></head>")
		...
		call append(line(".")+2, "//Mail: libanghuai@pku.edu.cn") 
	...
	if expand("%:e") == 'cpp'
		...
		call append(line(".")+18, "const int INF = 100000000;")
		call append(line(".")+19, "const int maxn = 100;")
